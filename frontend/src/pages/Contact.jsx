        ...
        <div className="grid lg:grid-cols-3 items-center">
          <div className="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
            ...
            >
              ...
              <h4 className="text-gray-100 text-base font-bold mt-4">
                Visit office
              </h4>
            ...
            >
              ...
              <h4 className="text-gray-100 text-base font-bold mt-4">Fax</h4>
              <p className="text-sm text-gray-300 mt-2">+1-548-2588</p>
            </div>
          </div>

          <div className="lg:col-span-2 bg-white rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
            <h2 className="text-3xl text-gray-900 text-center font-bold mb-6">
              Contact us
            </h2>
